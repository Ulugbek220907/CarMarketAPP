...
function formatCar(row) {
  ...
  return {
    ...
    distance: row.distance || '5 miles away',
    description: row.description || '',
    sellerName: row.seller_name || 'Seller',
    sellerPhone: row.seller_phone || '+1 (512) 555-0100',
...
router.post('/', async (req, res) => {
  try {
    ...
    const params = [
      ...
      b.distance || '0 miles away',
      b.description || '',
      b.sellerName || 'Alex (You)',
      b.sellerPhone || '+1 (512) 555-0192',
      parseFloat(b.sellerRating || 5.0),
      parseInt(b.sellerReviewCount || 1, 10),
      b.sellerResponseTime || 'Replies < 5 mins',
